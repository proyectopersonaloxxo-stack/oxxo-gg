...
# Nota: El archivo CSV se perderá cada vez que Render reinicie el servidor, pero el historial funciona localmente.
...
# 3. GUARDAR EN EL HISTORIAL (CSV - Se recomienda base de datos para la nube, pero mantenemos CSV por simplicidad)
...
# En la nube, esta falla es esperada ya que el CSV se borra con frecuencia.
